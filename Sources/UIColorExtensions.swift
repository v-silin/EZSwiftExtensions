...
//
    ...
    extension UIColor {
        ...
        // DyamicColor conflict
        public convenience init(r: Double, g: Double, b: Double, a: Double = 1) {
        ...
        public static func random(randomAlpha: Bool = false) -> UIColor {
            let randomRed = CGFloat(Float.random())
            let randomGreen = CGFloat(Float.random())
            let randomBlue = CGFloat(Float.random())
            let alpha = randomAlpha ? CGFloat(Float.random()) : 1.0
